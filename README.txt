================================================================================
Count_Worms_8Regions_TTX_zxl_Ver1.ijm
Fiji/ImageJ macro for high-throughput worm counting across 8 horizontal zones in thermotaxis assays
================================================================================
...
2.1. Close all Fiji windows (Results, Log, ROI Manager).
2.2. Drag your image into Fiji -> click Run on this macro.
2.3. Follow the pop-up instructions step-by-step:
   a) Open image
   b) Set threshold (worms = red) -> Apply
   c) Analyze Particles (suggested: size 30-infinity, circularity 0)
   d) Clean ROI list (add missed, delete false)
   e) Pick output folder -> done
...
dir = ...     hard-coded   Default save folder
